...
app.post("/submit", (req, res) => {
  ...
  const random_adj = Math.floor(Math.random() * adj.length);
  const random_noun = Math.floor(Math.random() * noun.length);
  const adjName = adj[random_adj];
  const nounName = noun[random_noun];
